<script setup>
  const serviceCardStyle = "ease-in duration-300 p-4 md:p-6 rounded-md hover:shadow-2xl"
</script>


<template>
    <section id="services" class="py-8 md:py-16">
      <div class="container mx-auto px-4 md:px-10">
        <div class="text-center pb-8 md:pb-16">
          <p class="text-2xl md:text-3xl pb-2 font-semibold text-[#e8505b]">Delivery Services</p>
          <h1 class="text-4xl md:text-5xl font-bold">All Essentials You Need</h1>
        </div>
